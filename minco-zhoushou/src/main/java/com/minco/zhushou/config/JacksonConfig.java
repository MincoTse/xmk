...
public class JacksonConfig {
    ...
    private void setJavaTimeModule(Jackson2ObjectMapperBuilder jacksonObjectMapperBuilder) {
    ...
    private void setLongModule(Jackson2ObjectMapperBuilder jacksonObjectMapperBuilder) {
